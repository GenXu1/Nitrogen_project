...
d1=fread("Glu.CHH_Teo_Maize_input.txt", header=T,data.table=F,na.strin="NA")
d1=d1[,c(1:2,23:36)]
...
write.table(res,file="CHH_DNA-meth_exon.txt",row.names = F,quote = F,sep="\t")

d=fread("CHH_DNA-meth_exon.txt", header=T,data.table=F,na.strin="NA")
pdf("CHH_DNA-meth_exon.pdf",height = 2.7,width = 5.5)
